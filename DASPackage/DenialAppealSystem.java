...
public class DenialAppealSystem extends javax.swing.JFrame {
    ...
    private String[] global_patientInfo = new String[17];
    private String global_appealDescription;
    ...
    /* --------------------------------------------------------------------------------------------------
     * The following methods allow a default text to appear in the login and password entry fields.
     * When the username or password textfields are selected, the default text disappears and allows
     * the user to enter their corresponding username and password. If none were entered and the user
     * selects another part of the GUI, the default text re-appears. 
     */
